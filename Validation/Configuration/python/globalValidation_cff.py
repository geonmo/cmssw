...
ValidationGEMOnly = cms.Sequence(gemSimValid+me0SimValid) 
...
modifyConfigurationStandardSequencesGlobalValidationForPhase2Dev_ = eras.phase2dev_muon.makeProcessModifier( _modifyGlobalValidationForPhase2 )
