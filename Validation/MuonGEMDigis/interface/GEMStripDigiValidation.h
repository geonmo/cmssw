...
public:
 ...
 private:
  ...
  std::map< const char* , MonitorElement* > theStrip_ro_phi;
	std::map< const char* , MonitorElement* > theStrip_st_dphi;
  std::map< const char* , MonitorElement* > theStrip_phiz_st_ch;
